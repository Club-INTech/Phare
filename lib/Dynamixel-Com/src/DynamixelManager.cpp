...
{
#if defined(__MK20DX128__) || defined(__MK20DX256__) || defined(__MK64FX512__) || defined(__MK66FX1M0__) || defined(__MK64FX512__) || defined(__MK66FX1M0__) || defined(ESP32)
    serial = dynamixelSerial;
    ((HardwareSerial*)serial)->begin(baudrate, SERIAL_8N1, 16,17);
